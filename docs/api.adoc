...
More about Unexp nodes can be found in the xref:appendix.adoc#_unexpanded_entity_references[appendix], but generally speaking, you will rarely (if ever) encounter them.
